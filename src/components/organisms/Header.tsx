          ...
          return (
            <>
              ...
              >
                <Menu.Items as="div" className="fixed inset-0 w-screen bg-gray-100">
                  <nav className="flex h-full w-full flex-col items-center justify-center space-y-6 text-center text-xl font-medium tracking-wider text-gray-800">
                    ...
                    >
                      <Menu.Item>
                        <a href="/partneri" className="rounded-lg border border-gray-800 px-8 py-3 text-gray-800">
                          Pro partnery
                        </a>
                      </Menu.Item>
                    </Transition.Child>
              ...
              <nav className="hidden items-center space-x-4 text-lg font-medium tracking-wide text-gray-700 lg:flex">
                <a href="/kontakt" className="px-2">
                  Kontakt
                </a>
                <a href="/blog" className="px-2">
                  Blog
                </a>
                <a href="/partneri" className="-my-2.5 rounded-lg border border-gray-800  px-6 py-2.5 text-gray-800">
                  Pro Partnery
                </a>
